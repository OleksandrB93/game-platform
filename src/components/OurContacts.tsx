...
const OurContacts = () => {
  return (
    <div className="mt-8 mb-12 p-5 bg-outline w-[345px] mx-auto rounded-2xl ">
      <img
        src={process.env.PUBLIC_URL + "/imgs/contacts.png"}
        className="uppercase text-textAccent mx-auto mb-4"
      />
      <div className="mb-4">
        <p className="text-sm mb-2">Адреса:</p>
        <p className="text-md italic font-semibold">
          Українаб 74000 <br /> м.Львів, Пл. Петрушевича,1
        </p>
      </div>
      <div className="mb-4">
        <p className="text-sm mb-2">Тедефон:</p>
        <address>
          <a className="text-md font-semibold" href="tel:+380970123456">
            +380970123456
          </a>
        </address>
      </div>
      <div className="mb-4">
        <p className="text-sm mb-2">Поштова скринька:</p>
        <address>
          <a
            className="text-md font-semibold text-textAccent"
